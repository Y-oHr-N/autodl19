...
class FT_tf_model(object):
    def __init__(self, config):
        ...
        with tf.variable_scope("FT", reuse=tf.AUTO_REUSE):
            ...
            # avg = tf.reduce_mean(embed1_word, axis = 1)
    ...
    def get_token_embeddings(
        self, vocab_size, num_units, zero_pad=True, name="shared_weight_matrix"
    ):
    ...
    def predict(self, X, batch_size=64, training=False):
        ...
        saver = tf.train.Saver()
        # print('dshjdhsjhdjshdjshdjshjdhsjdhsjhd......:',len(X), batch_size, rounds)
        with tf.Session() as sess:
